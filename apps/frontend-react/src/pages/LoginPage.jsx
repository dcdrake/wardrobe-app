...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto">
      <h1 className="text-2xl font-serif font-semibold text-espresso-800 text-center mb-8">Login</h1>
      <form onSubmit={handleSubmit} className="bg-cream p-8 rounded-xl border border-sand-200/60">
        ...
        <div className="mb-6">
          ...
          <input value={password} onChange={e => setPassword(e.target.value)} type="password" required className="w-full px-3 py-2 bg-cream border border-sand-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracotta-400 focus:border-transparent" />
        </div>
        ...
        <p className="mt-4 text-center text-charcoal-400">
          No account? <Link to="/signup" className="text-terracotta-500 hover:text-terracotta-600">Sign up</Link>
        </p>
      </form>
    </div>
  )
